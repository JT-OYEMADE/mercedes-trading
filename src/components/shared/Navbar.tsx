...
const navigationItems = [
  ...
  { label: 'Gallery', href: '/gallery' },
  { label: 'About Us', href: 'about', isScroll: true },
];
...
export const Navbar = () => {
  ...
  const darkNavLink = ['/contact', '/gallery', '/product'];
  const isDarkNav =
    darkNavLink.includes(pathname) ||
    darkNavLink.some((link) => pathname?.startsWith(link + '/'));
                    ...
                    <ul role='list' className='space-y-6'>
                      {navigationItems.map((item) => (
                        <li key={item.label}>
                          {item.submenu ? (
                            <div>
                              <p className='font-normal text-lg text-gray mb-3'>
                                {item.label}
                              </p>
                              <ul className='ml-4 space-y-3'>
                                {item.submenu.map((subItem) => (
                                  <li key={subItem.label}>
                                    <Link
                                      href={subItem.href}
                                      className={`font-normal text-base ${pathname === subItem.href ||
                            ...
                            <>
                              {item.isScroll ? (
                                ...
                                <Link
                                  href={item.href}
                                  className={`font-normal text-lg ${pathname === item.href ||
              ...
              <img
                ...
                src={
                  isScrolled || isDarkNav
                    ? '/images/mercedes-blue-logo.svg'
                    : '/images/mercedes-logo-white.svg'
                }
                alt='Mercedes'
              />
            </Link>
                        ...
                        <div className='py-2'>
                          {item.submenu.map((subItem) => (
                            <Link
                              key={subItem.label}
                              href={subItem.href}
                              className={`block px-4 py-3 text-sm transition-colors hover:bg-gray-50 hover:text-primary ${pathname === subItem.href ||
                                pathname?.startsWith(subItem.href + '/')
