      ...
      <div className='container'>
        <div className='flex flex-col md:flex-row md:px-8 gap-10 md:gap-[130px]'>
          <div className='md:w-1/2'>
            ...
            <p className='text-dark/70 text-xl mt-2.5 md:mt-5'>
              <span className='text-dark font-medium'>Mailing Address:</span> B36, Anambra
              Plaza, International Trade Fair Complex, Badagry Expressway, Lagos State, 102101,
              Nigeria.
            </p>
            <p className='text-dark/70 text-xl mt-2.5 md:mt-5'>
              <span className='text-dark font-medium'>Operating Address:</span> Warehouse 1,
              Opposite Coca-Cola, Lemu Rd, Bida, Niger State, 912101, Nigeria.
            </p>
            <div className='mt-12'>
              {/* <Link
            ...
            <form onSubmit={handleSubmit}>
              <div className='space-y-4 mb-6'>
                ...
                <Textfield
                  ...
                  onChange={(e: any) =>
                    handleInputChange('otherSpecification', e.target.value)
                  }
                />
                <Textfield
                  id='gradeExpectation'
                  placeholder='Preferred quality specification'
